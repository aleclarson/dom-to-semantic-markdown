...
describe('HTML to Markdown conversion', () => {
  ...
  test('respects conversion options', () => {
    const html =
      '<div id="content" role="main"><p>Main content</p></div><div id="sidebar"><p>Sidebar</p></div>'
            ...
            return [
              {
                ...
                href: href,
                content: [
                  { type: 'text', content: element.textContent?.trim() || '' },
                ],
              },
            ]
          }
    ...
    const options: ConversionOptions = {
      processUnhandledElement: element => {
        return [
          {
            type: 'text',
            content: `[Unknown: ${element.tagName}] ${element.textContent}`,
          },
        ]
      },
      overrideDOMParser: new dom.window.DOMParser(),
